...
// HOSTNAME = "http://16.171.115.34:5000"
HOSTNAME = "https://test.tendersspace.com"
...
const GLOBELCONSTANT = {
    AUTH: {
        ...
        UPDATE_PASSWORD_ON_FIRST_LOGIN: API + "user/update-inital-login",
    ...
    JOB: {
        ...
        APPLY_JOB: API + "jobs/apply/:jobId/:userId",
        ...
        JOB_APPLIED_BY_USERS: API +  "jobs/applied/jobs/:userId",
